...
<body>
	<div class="header" id="home">
		<div class="header-top">
			<div class="container">
			   <div class="logo">
				  <a href="index.php"><b>ODLMS</b><span>lab</span></a>
				</div>
				<div class="top-menu">
					<span class="menu"><img src="images/nav.png" alt=""/> </span>
						<ul>
						<li><a href="index.php" class="active scroll"><b>home</b></a></li>
						<li><a href="#aboutus" class="scroll"><b>about us</b></a></li>
						<li><a href="#gallery" class="scroll"><b>gallery</b></a></li>
						<li><a href="admin/login.php"><b>Admin</b></a></li>
						<li><a href="user/login.php"><b>Users</b></a></li>
						<li><a href="employee/login.php"><b>Employee</b></a></li>
					</ul>
				</div>
					 <!--script-nav-->
						 <script>
...
<!--//gallery-->
	...
	<div class="footer-section">
						...
						<p><b>Online Diagnostic Lab Management System @ 2022</b></p>
									</div>
							<script type="text/javascript">
